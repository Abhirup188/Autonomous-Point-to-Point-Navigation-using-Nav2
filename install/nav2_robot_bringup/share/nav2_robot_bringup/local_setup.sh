...
: ${AMENT_CURRENT_PREFIX:="/home/abhirup-chakraborty/nav_project/install/nav2_robot_bringup"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_robot_bringup/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_robot_bringup/environment/path.sh"
